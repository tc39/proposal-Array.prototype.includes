...
/*---
description: Array.prototype.contains should clamp positive lengths to 2^53 - 1
...
if (Array.prototype.contains.call({ length: 1, 0: 'a' }, 'a') !== true) {
    $ERROR('Expected { length: 1, 0: \'a\' } to contain \'a\'');
}

if (Array.prototype.contains.call({ length: +Infinity, 0: 'a' }, 'a') !== true) {
